...
async function vizualizarInformacoesGlobais() {
    ...
    paragrafo.innerHTML = `
        ...
        <span>${horas} horas</span> e <span>${minutos} minutos</span> conectadas.
        <br>Isso significa que aproximadamente <span>${porcentagemConectada}%</span> das pessoas estão conectadas.
    `;
...
document.addEventListener('DOMContentLoaded', vizualizarInformacoesGlobais);
